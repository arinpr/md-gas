...
const AppointmentDateRangePicker = ({ type, value, onChange }) => {
  ...
  useEffect(() => {
    ...
    if (incomingDateStr !== last.date || incomingTime !== last.time) {
      lastAppliedRef.current = { date: incomingDateStr, time: incomingTime };
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 items-stretch h-full">
        ...
        <div className="border-b lg:border-b-0 lg:border-r border-slate-200 p-5 sm:p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <div className="text-xs text-slate-500">Next 2 months only</div>
          </div>
        ...
        <div className="p-5 sm:p-6 flex flex-col h-[510px] overflow-y-auto">
          ...
          <div className="flex items-center justify-between gap-3 mb-3">
            ...
            {date ? (
              ...
              <div className="text-xs text-slate-500">No date selected</div>
            )}
          </div>
          ...
          <div className="flex-1 min-h-0 overflow-y-auto pr-1">
            {!serviceKey ? (
              ...
              <div className="rounded-lg border border-rose-200 bg-rose-50 p-4">
                ...
                <div className="text-sm text-rose-800 mt-1">{error}</div>
              </div>
            ) : !date ? (
              <div className="rounded-lg border border-slate-200 bg-white p-4">
                <div className="text-sm font-medium text-slate-900">
                      ...
                      <div className="flex items-center justify-between gap-3">
                        <div className="flex flex-col">
                          ...
                          <span className="text-xs text-slate-500">
                            {active ? "Chosen slot" : "Tap to choose"}
                          </span>
                        </div>
