              ...
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div className="space-y-8">
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed max-w-xl">
                    For over a decade, MD Gas has been providing professional boiler services across Greater London with transparent pricing and reliable engineering.
                  </p>
                  ...
                  <div className="space-y-6 pt-4">
                    <div className="flex flex-col sm:flex-row gap-4">
                      <Button asChild size="lg" className="rounded-xl px-8 text-foreground bg-gradient-to-r from-dark via-dark/80 to-primary hover:from-gray-800 hover:to-gray-900 shadow-md hover:shadow-lg transition-all duration-300">
                      ...
                      <Button asChild size="lg" variant="outline" className="rounded-xl px-8 border-gray-300 bg-gray-50 hover:border-gray-400 transition-all">
                        <Link href="/services">
                          <span className="flex items-center gap-2">
                            View All Services
                          </span>
                ...
                <div className="relative">
                  ...
                  <div className="mt-8 bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    <div className="grid grid-cols-4 divide-x divide-gray-200">
                      {STATS.map((s) => (
                        <div key={s.key} className="px-4 text-center">
                          <div className="text-2xl font-bold text-gray-900">
                            {s.key === "support" ? "24/7" : `${s.value}${s.value >= 1000 ? "+" : ""}`}
                          </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="max-w-3xl mx-auto text-center">
                <div className="inline-flex items-center gap-2 mb-4">
                  ...
                  <span className="text-sm font-medium text-indigo-600 uppercase tracking-wider">Our Foundation</span>
                </div>
                <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 tracking-tight">
                  Built on Core Values
                </h2>
                <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
                  Safety, quality and customers-first — the foundation of every job we complete in Greater London.
                </p>
              </div>
              ...
              <div className="mt-12 lg:mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                {VALUES.map((value) => (
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-white to-indigo-50/30 opacity-0 
              ...
              <div className="mt-16 pt-8 border-t border-gray-200">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                  <div>
                    <p className="text-sm text-gray-500 uppercase tracking-wider">Why it matters</p>
                    <h3 className="text-lg font-semibold text-gray-900 mt-1">
                      Your safety and satisfaction come first
                    </h3>
                  </div>
 
                  <div className="flex flex-wrap gap-4">
                    {[
                      { value: "100%", label: "Gas Safe Compliance" },
                    ...
                    <div className="space-y-8 pl-6">
                      <div>
                        ...
                        <p className="text-gray-600 leading-relaxed">
                          Started in 2012 with a simple mission: provide honest, reliable heating services at fair prices to London homeowners.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 leading-relaxed">
                          Grew through word-of-mouth by consistently delivering quality workmanship and building lasting relationships.
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 leading-relaxed">
                          Today, we're a team of certified engineers using advanced diagnostic tools while maintaining our founding principles.
                        </p>
                      </div>
                    </div>
                  </div>
  ...
  <div className="relative">
    ...
    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-r from-black/70 to-transparent p-6 rounded-b-2xl">
      <div className="flex items-center justify-between">
        <div>
          <p className="text-white font-semibold">MD Gas Engineers</p>
          <p className="text-white/80 text-sm mt-1">Gas Safe Certified • London</p>
        </div>
  ...
  <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-white via-gray-50 to-indigo-50/30 border border-gray-100 shadow-xl">
    ...
    <div className="grid lg:grid-cols-2 gap-0">
      ...
      <div className="relative p-8 lg:p-12 bg-gradient-to-br from-indigo-600/10 to-blue-600/10">
        ...
        <div className="relative z-10">
          <div className="inline-flex items-center gap-3 mb-8">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-indigo-600 to-blue-600 
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm">Unchanging since day one</p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-semibold text-gray-900">Integrity First</p>
                <p className="text-gray-600 text-sm">Honest service, fair pricing</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <div className="w-3 h-3 rounded-full bg-blue-600" />
              <div>
                <p className="font-semibold text-gray-900">Quality Craftsmanship</p>
                <p className="text-gray-600 text-sm">Work that lasts</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
      ...
      <div className="p-8 lg:p-12">
        <div className="relative">
          <div className="absolute -top-2 -left-2 text-5xl text-indigo-100 font-serif">"</div>
 
          <blockquote className="text-xl lg:text-2xl text-gray-800 leading-relaxed font-light pl-6">
            To deliver exceptional heating services with integrity, transparency, and craftsmanship that stands the test of time — ensuring every home we serve enjoys reliable warmth and peace of mind.
          </blockquote>
 
          <div className="absolute -bottom-2 -right-2 text-5xl text-indigo-100 font-serif rotate-180">"</div>
        </div>
 
        <div className="mt-10 pt-8 border-t border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="font-semibold text-gray-900">MD Gas Team</p>
              <p className="text-sm text-gray-600">Trusted since 2012</p>
            </div>
    ...
    <div className="absolute bottom-6 right-6">
      ...
      <p className="text-lg text-gray-600 max-w-2xl mx-auto">
        Our professional certifications ensure the highest standards of safety and quality.
      </p>
    </div>
      ...
      {[
        ...
        return (
          ...
          >
            ...
            {/* Number indicator */}
            <div className="absolute -top-3 -left-3 w-8 h-8 rounded-full bg-gradient-to-r from-indigo-600 to-blue-600 
                          text-white flex items-center justify-center text-sm font-bold shadow-md">
              {index + 1}
            </div>
 
            {/* Icon with gradient */}
            <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${cert.color} 
            ...
            <div className="mt-6 pt-6 border-t border-gray-100 flex items-center justify-between">
              <span className="text-xs font-medium text-indigo-600">Verified & Certified</span>
...
<section className="relative py-16 overflow-hidden rounded-b-3xl">
  ...
  <div className="relative max-w-3xl mx-auto px-4 text-center">
    ...
    <p className="mt-4 text-lg text-white/90">
      Book a free quote or request emergency service — we’ll be there.
    </p>
 
    <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
      <Button asChild size="lg" className="rounded-full bg-white text-indigo-600 hover:bg-gray-100 px-10 shadow-lg">
        <Link href="/book/quote">
          Get a Quote
        </Link>
      </Button>
 
      <Button asChild variant="outline" size="lg" className="rounded-full border-white text-white hover:bg-white/10 px-10">
        <Link href="tel:08001234567" className="inline-flex items-center gap-2">
