          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mt-6 text-lg text-muted-foreground">
                For over 15 years, MD Gas has been providing expert boiler services to homeowners across Greater London.
                Our team of Gas Safe registered engineers is committed to delivering safe, reliable, and affordable
                heating solutions.
              </p>
            </div>
          </div>
            ...
            <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
              <div>
                ...
                <div className="mt-6 space-y-4 text-muted-foreground">
                  <p>
                    MD Gas was founded with a simple mission: to provide honest, reliable boiler services at fair
                    prices. What started as a one-man operation has grown into a trusted team of skilled engineers
                    serving thousands of homes across the Greater London area.
                  </p>
                  <p>
                    Over the years, we've built our reputation on transparency, quality workmanship, and exceptional
                    customer service. We believe in doing the job right the first time, and our fixed pricing means
                    you'll never face unexpected costs.
                  </p>
                  <p>
                    Today, MD Gas continues to grow while maintaining the personal touch and attention to detail that
                    our customers have come to expect. Whether you need an emergency repair or a full boiler
        ...
        <section className="py-16 sm:py-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 text-muted-foreground">We maintain the highest industry standards</p>
            </div>

            <div className="mt-12 flex flex-wrap items-center justify-center gap-8">
              {["Gas Safe Registered", "OFTEC Certified", "Which? Trusted Trader", "Checkatrade Verified"].map((cert) => (
                <div
                  key={cert}
        ...
        <section className="bg-primary py-16">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="mt-4 text-primary-foreground/80">
              Contact us today for a free quote or to book a service
            </p>
