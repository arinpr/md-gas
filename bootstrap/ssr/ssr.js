...
function Header({
    ...
    return /* @__PURE__ */ jsx("header", {
        className: "absolute top-4 w-full z-50", children: /* @__PURE__ */ jsxs("div", {
            className: "relative", children: [
    /* @__PURE__ */ jsxs("div", {
                className: "mx-auto flex max-w-7xl items-center gap-6 px-4 py-4 sm:px-2 lg:px-6", children: [
      /* @__PURE__ */ jsxs(
                    Link,
                    {
                        href: "/",
      ...
      /* @__PURE__ */ jsx("nav", {
                    className: "hidden flex-1 items-center justify-center gap-3 md:flex z-50", children: NAV_ITEMS.map((item) => {
      ...
      /* @__PURE__ */ jsxs("div", {
                    className: "ml-auto flex items-center gap-4", children: [
        /* @__PURE__ */ jsx(
                        "img",
                        {
        ...
        /* @__PURE__ */ jsx(
                ...
                isMegaOpen && /* @__PURE__ */ jsx("div", {
                    className: "pointer-events-auto hidden md:block", children: /* @__PURE__ */ jsx("div", {
                        className: "absolute left-1/2 top-0 z-30 w-full max-w-3xl -translate-x-1/2 px-4 pb-6 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsx("div", {
                            className: "mt-2 rounded-3xl bg-white shadow-xl", children: /* @__PURE__ */ jsx("div", {
                                className: "grid grid-cols-1 gap-6 p-6 md:grid-cols-3 md:p-8 !pt-20", children: currentCards.map((card) => /* @__PURE__ */ jsxs(
                                    "a",
                                    {
                                        href: card.href,
                                        onClick: closeMega,
          ...
          /* @__PURE__ */ jsx("div", { className: "mt-4 flex justify-end", children: /* @__PURE__ */ jsx("span", { className: "flex h-9 w-9 items-center justify-center rounded-full bg-black text-white transition group-hover:translate-x-1", children: /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" }) }) })
                ...
                mobileMenuOpen && /* @__PURE__ */ jsx("div", {
                    className: "md:hidden border-t border-slate-200 bg-white/95 backdrop-blur-sm", children: /* @__PURE__ */ jsxs("nav", {
                        className: "flex flex-col space-y-2 px-4 py-4", children: [
      /* @__PURE__ */ jsx(
                            "a",
                            {
                                href: "/#services",
...
function Footer() {
    return /* @__PURE__ */ jsx("footer", {
        id: "contact", className: "", children: /* @__PURE__ */ jsxs("div", {
            className: "mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxs("div", {
                className: "grid gap-8 sm:grid-cols-2 lg:grid-cols-4", children: [
      /* @__PURE__ */ jsxs("div", {
                    children: [
        /* @__PURE__ */ jsxs(Link, {
                        href: "/", className: "flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        /* @__PURE__ */ jsxs("ul", {
                        className: "space-y-2 text-sm text-foreground/70", children: [
          /* @__PURE__ */ jsx("li", {
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        /* @__PURE__ */ jsxs("ul", {
                        className: "space-y-3 text-sm text-foreground/70", children: [
          /* @__PURE__ */ jsxs("li", {
    ...
    /* @__PURE__ */ jsx("div", {
                className: "mt-8 border-t border-border pt-8", children: /* @__PURE__ */ jsxs("div", {
                    className: "flex flex-col items-center justify-between gap-4 sm:flex-row", children: [
      /* @__PURE__ */ jsxs("p", {
                        className: "text-sm text-foreground/70", children: [
                            "© ",
      ...
      /* @__PURE__ */ jsxs("div", {
                        className: "flex gap-6 text-sm text-foreground/70", children: [
        /* @__PURE__ */ jsx(
                            Link,
                            {
                                href: "/about",
...
function AboutPage() {
    ...
    /* @__PURE__ */ jsxs("div", {
            className: "min-h-screen rounded-b-3xl bg-foreground text-gray-900", children: [
      /* @__PURE__ */ jsx(Header, { title: pageTitle2 }),
      /* @__PURE__ */ jsxs("main", {
                className: "w-full", children: [
        /* @__PURE__ */ jsxs("section", {
                    className: "relative pt-40 pb-14 px-4 sm:px-6 lg:px-0 overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsx("div", {
                        className: "relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", {
                            className: "grid lg:grid-cols-2 gap-12 lg:gap-16 items-center", children: [
            /* @__PURE__ */ jsxs("div", {
                                className: "space-y-8", children: [
              /* @__PURE__ */ jsxs("div", {
                                    className: "inline-flex items-center gap-2 bg-indigo-50 border border-indigo-100 text-indigo-700 px-4 py-2 rounded-full", children: [
              ...
              /* @__PURE__ */ jsxs("div", {
                ...
                /* @__PURE__ */ jsxs("h1", {
                                        className: "text-4xl lg:text-5xl font-bold text-gray-900 tracking-tight", children: [
                                            "Reliable Heating",
              ...
              /* @__PURE__ */ jsx("div", {
                                    className: "space-y-6 pt-4", children: /* @__PURE__ */ jsxs("div", {
                ...
                /* @__PURE__ */ jsx(
                                            Button,
                                            {
                                                ...
                                                children: /* @__PURE__ */ jsx(Link, {
                                                    href: "/book/quote", children: /* @__PURE__ */ jsxs("span", {
                                                        className: "flex items-center gap-2", children: [
                                                            "Book a Service",
                      /* @__PURE__ */ jsx(
                                                                "svg",
            ...
            /* @__PURE__ */ jsxs("div", {
                                className: "relative", children: [
              /* @__PURE__ */ jsxs("div", {
                                    className: "relative overflow-hidden rounded-3xl shadow-xl", children: [
                /* @__PURE__ */ jsx(
                                        "img",
                                        {
                ...
                /* @__PURE__ */ jsxs("div", {
                                        className: "absolute top-6 right-6 bg-white/95 backdrop-blur-sm rounded-xl px-4 py-3 shadow-lg", children: [
              ...
              /* @__PURE__ */ jsx("div", {
                                    className: "mt-8 bg-white rounded-2xl shadow-sm border border-gray-100 p-6", children: /* @__PURE__ */ jsx("div", {
                                        className: "grid grid-cols-4 divide-x divide-gray-200", children: STATS.map((s) => /* @__PURE__ */ jsxs(
                                            "div",
                                            {
        ...
        /* @__PURE__ */ jsxs("section", {
          ...
          /* @__PURE__ */ jsxs("div", {
            ...
            /* @__PURE__ */ jsx("div", {
                            className: "mt-12 lg:mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8", children: VALUES.map((value) => /* @__PURE__ */ jsxs(
                                "div",
                                {
                  ...
                  /* @__PURE__ */ jsx("div", {
                                        className: "mt-6 pt-6 border-t border-gray-100", children: /* @__PURE__ */ jsxs("div", {
                                            className: "inline-flex items-center gap-2 text-sm text-gray-500", children: [
            ...
            /* @__PURE__ */ jsx("div", {
                            className: "mt-16 pt-8 border-t border-gray-200", children: /* @__PURE__ */ jsxs("div", {
        ...
        /* @__PURE__ */ jsxs("section", {
                    className: "relative py-20 lg:py-24 overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsx("div", {
                        className: "absolute inset-0 opacity-5", children: /* @__PURE__ */ jsx(
                            "div",
                            {
          ...
          /* @__PURE__ */ jsxs("div", {
                        className: "relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
            /* @__PURE__ */ jsxs("div", {
                            className: "grid lg:grid-cols-2 gap-16 items-center", children: [
              /* @__PURE__ */ jsxs("div", {
                                className: "space-y-8", children: [
                /* @__PURE__ */ jsxs("div", {
                ...
                /* @__PURE__ */ jsxs("h2", {
                                    className: "text-4xl lg:text-5xl font-bold text-gray-900 leading-tight", children: [
                                        "From a single van",
                ...
                /* @__PURE__ */ jsxs("div", {
                  ...
                  /* @__PURE__ */ jsxs("div", {
                                        className: "space-y-8 pl-6", children: [
                    /* @__PURE__ */ jsxs("div", {
                                            children: [
              ...
              /* @__PURE__ */ jsxs("div", {
                ...
                /* @__PURE__ */ jsxs("div", {
                                    className: "relative", children: [
                  /* @__PURE__ */ jsx("div", {
                                        className: "overflow-hidden rounded-2xl shadow-lg border border-gray-100", children: /* @__PURE__ */ jsx(
                                            "img",
                                            {
                  ...
                  /* @__PURE__ */ jsx("div", {
                                        className: "absolute top-6 right-6", children: /* @__PURE__ */ jsx("div", {
                                            className: "bg-gradient-to-r from-indigo-600 to-blue-600 text-white rounded-xl px-4 py-3 shadow-lg", children: /* @__PURE__ */ jsxs("div", {
                  ...
                  /* @__PURE__ */ jsx("div", {
                                        className: "absolute bottom-0 left-0 right-0 bg-gradient-to-r from-black/70 to-transparent p-6 rounded-b-2xl", children: /* @__PURE__ */ jsxs("div", {
                    ...
                    /* @__PURE__ */ jsxs("div", {
                                                className: "flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-lg px-3 py-2", children: [
                      /* @__PURE__ */ jsx(
                                                    "svg",
                                                    {
            ...
            /* @__PURE__ */ jsx("div", {
                            className: "mt-24", children: /* @__PURE__ */ jsxs("div", {
                                className: "relative overflow-hidden rounded-3xl bg-gradient-to-br from-white via-gray-50 to-indigo-50/30 border border-gray-100 shadow-xl", children: [
              /* @__PURE__ */ jsxs("div", {
                                    className: "absolute top-0 left-0 w-full h-full opacity-5", children: [
              ...
              /* @__PURE__ */ jsxs("div", {
                                    className: "grid lg:grid-cols-2 gap-0", children: [
                /* @__PURE__ */ jsxs("div", {
                                        className: "relative p-8 lg:p-12 bg-gradient-to-br from-indigo-600/10 to-blue-600/10", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", {
                    ...
                    /* @__PURE__ */ jsxs("div", {
                                                className: "inline-flex items-center gap-3 mb-8", children: [
                      /* @__PURE__ */ jsx(
                                                    "div",
                                                    {
                ...
                /* @__PURE__ */ jsxs("div", {
                                        className: "p-8 lg:p-12", children: [
                  /* @__PURE__ */ jsxs("div", {
                                            className: "relative", children: [
                  ...
                  /* @__PURE__ */ jsx("div", {
                                            className: "mt-10 pt-8 border-t border-gray-100", children: /* @__PURE__ */ jsxs("div", {
                                                className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxs("div", {
                                                    children: [
                    ...
                    /* @__PURE__ */ jsx("div", {
                                                    className: "flex items-center gap-2", children: [1, 2, 3].map(
                                                        (_, i) => /* @__PURE__ */ jsx(
                                                            "div",
                                                            {
        ...
        /* @__PURE__ */ jsx("section", {
                    className: "py-16 lg:py-3", children: /* @__PURE__ */ jsxs("div", {
                        className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsxs("div", {
                            className: "text-center mb-12 lg:mb-16", children: [
            /* @__PURE__ */ jsxs("div", {
                                className: "inline-flex items-center gap-3 mb-4", children: [
              /* @__PURE__ */ jsx("div", { className: "h-px w-12 bg-gradient-to-r from-indigo-500 to-blue-500" }),
          ...
          /* @__PURE__ */ jsx("div", {
                            className: "relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8", children: [
                                {
                  ...
                  /* @__PURE__ */ jsxs("div", {
                                            className: "mt-6 pt-6 border-t border-gray-100 flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsxs("section", {
                    className: "relative py-16 overflow-hidden rounded-b-3xl", children: [
          ...
          /* @__PURE__ */ jsxs("div", {
                        className: "relative max-w-3xl mx-auto px-4 text-center", children: [
            ...
            /* @__PURE__ */ jsxs("div", {
                            className: "mt-8 flex flex-col sm:flex-row items-center justify-center gap-4", children: [
              /* @__PURE__ */ jsx(
                                Button,
                                {
                                    asChild: true,
...
function GuestLayout({ children }) {
    ...
    return /* @__PURE__ */ jsxs("div", {
        className: "flex min-h-screen flex-col relative", children: [
    /* @__PURE__ */ jsx(Header, {}),
            children,
    /* @__PURE__ */ jsx(Footer, {})
        ]
...
function Login({ status, canResetPassword }) {
    ...
    return /* @__PURE__ */ jsxs("div", {
        className: "min-h-screen flex justify-center items-center bg-gray-100 px-4", children: [
    /* @__PURE__ */ jsx(Head, { title: "Login" }),
    /* @__PURE__ */ jsxs("div", {
            className: "w-full max-w-md bg-white shadow-xl rounded-2xl p-8", children: [
      /* @__PURE__ */ jsx("div", {
                className: "flex justify-center mb-4", children: /* @__PURE__ */ jsxs("div", {
                    className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold text-gray-900", children: "MD Gas" })
                ...
                status && /* @__PURE__ */ jsx("div", { className: "mb-4 text-sm font-medium text-green-600", children: status }),
      /* @__PURE__ */ jsxs("form", {
                    onSubmit: submit, className: "space-y-5", children: [
        /* @__PURE__ */ jsxs("div", {
                        children: [
        ...
        /* @__PURE__ */ jsxs("div", {
                        className: "flex items-center justify-between pt-2", children: [
    ...
    return /* @__PURE__ */ jsx(
        "section",
        {
            ...
            children: /* @__PURE__ */ jsxs("div", {
                className: "max-w-7xl mx-auto", children: [
        /* @__PURE__ */ jsxs("div", {
                    className: "flex justify-between items-center mb-10 z-20 bg-foreground pt-4 pb-6", children: [
        ...
        /* @__PURE__ */ jsx("div", {
                    className: "space-y-6", children: displayedFaqs.map((item, index) => {
                ...
                /* @__PURE__ */ jsx(
                    ...
                    showAll && /* @__PURE__ */ jsx("div", {
                        className: "text-center mt-10", children: /* @__PURE__ */ jsx(
                            "button",
                            {
...
function ServiceCards() {
    ...
    return /* @__PURE__ */ jsxs("section", {
        className: "relative overflow-hidden rounded-t-[45px] bg-gradient-to-b from-[#F4F7FB] via-[#F3F6FB] to-[#EEF3FA] py-16 sm:py-24", children: [
    ...
    /* @__PURE__ */ jsx("div", {
            className: "relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-0", children: /* @__PURE__ */ jsxs("div", {
                className: "grid gap-10 lg:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)] lg:items-start", children: [
      /* @__PURE__ */ jsxs("div", {
                    className: "flex flex-col gap-5", children: [
        /* @__PURE__ */ jsxs("div", {
                        className: "max-w-3xl", children: [
          /* @__PURE__ */ jsxs("h2", {
                            className: "text-3xl sm:text-4xl font-[500] tracking-tight text-dark leading-10", children: [
                                "Get a",
                                " ",
        ...
        /* @__PURE__ */ jsxs("div", {
                        className: "relative mt-3", children: [
          ...
          /* @__PURE__ */ jsx("div", {
                            className: "relative grid gap-4 sm:grid-cols-3", children: steps.map((step) => {
                  ...
                  /* @__PURE__ */ jsxs("div", {
                    ...
                    /* @__PURE__ */ jsx("div", {
                                                className: "flex items-center gap-3", children: /* @__PURE__ */ jsx("div", {
                                                    className: "flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-br from-slate-900 via-slate-900 to-slate-800 shadow-[0_14px_30px_rgba(15,23,42,0.55)]", children: /* @__PURE__ */ jsx(
                                                        Icon,
                                                        {
                  ...
                  /* @__PURE__ */ jsxs("div", {
                                            className: "mt-4 flex items-center justify-start gap-3", children: [
      ...
      /* @__PURE__ */ jsx("div", {
                    className: "relative h-full", children: /* @__PURE__ */ jsxs("div", {
                        className: "relative flex h-full flex-col rounded-[30px] border border-dashed border-slate-200/80 bg-white/90 p-6 sm:p-8 shadow-[0_22px_60px_rgba(15,23,42,0.12)] backdrop-blur-sm", children: [
        /* @__PURE__ */ jsxs("div", {
                            className: "absolute right-6 top-6 inline-flex items-center gap-2 rounded-full bg-slate-50 px-3 py-1 text-[11px] font-medium text-slate-500", children: [
          /* @__PURE__ */ jsx(CheckCircle2, { className: "h-4 w-4 text-primary" }),
                                "Online, start to finish"
                            ]
                        }),
        /* @__PURE__ */ jsxs("div", {
                            className: "mt-8 flex h-full flex-col gap-6", children: [
          /* @__PURE__ */ jsxs("div", {
                                className: "space-y-4", children: [
            ...
            /* @__PURE__ */ jsxs("ul", {
                                    className: "mt-4 space-y-3 text-[16px] text-dark", children: [
              /* @__PURE__ */ jsxs("li", {
          ...
          /* @__PURE__ */ jsxs("div", {
                                className: "flex flex-wrap gap-3 text-[15px] text-foreground", children: [
...
function WhyChooseUs() {
    return /* @__PURE__ */ jsxs("section", {
        className: "relative bg-dark/90 py-16 sm:py-20", children: [
    ...
    /* @__PURE__ */ jsxs("div", {
            className: "relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-0", children: [
      /* @__PURE__ */ jsxs("header", {
                className: "mx-auto max-w-3xl text-center", children: [
        /* @__PURE__ */ jsxs("div", {
                    className: "inline-flex items-center gap-2 rounded-full border border-primary bg-dark/30 px-3 py-1", children: [
      ...
      /* @__PURE__ */ jsx("div", {
                className: "mt-14 grid gap-6 md:grid-cols-2 items-stretch", children: BENEFITS.map((item) => {
              ...
              /* @__PURE__ */ jsx("div", {
                                className: "mt-1 flex h-14 w-14 items-center justify-center rounded-2xl bg-slate-900", children: /* @__PURE__ */ jsx("div", {
                                    className: "flex h-11 w-11 items-center justify-center rounded-xl bg-slate-950", children: /* @__PURE__ */ jsx(
                                        Icon,
                                        {
...
function HeroServices() {
    return /* @__PURE__ */ jsx("div", {
        className: "grid gap-5 md:grid-cols-2 xl:grid-cols-4", children: services.map((service) => /* @__PURE__ */ jsxs(
            Card,
            {
        ...
        /* @__PURE__ */ jsxs("div", {
                    className: "relative mt-1 flex h-44 w-full items-center justify-center", children: [
          /* @__PURE__ */ jsx("div", {
                        className: "absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2", children: /* @__PURE__ */ jsx(
                            GlowRipple,
                            {
        ...
        /* @__PURE__ */ jsxs("div", {
                    className: "flex items-end justify-between gap-4 mt-1", children: [
          /* @__PURE__ */ jsxs("div", {
                        children: [
          ...
          /* @__PURE__ */ jsx(Link, {
                        href: service.href, className: "shrink-0", children: /* @__PURE__ */ jsx(
                            "div",
                            {
...
function Home$1() {
    ...
    /* @__PURE__ */ jsxs("section", {
            className: "relative min-h-screen flex items-center justify-center bg-gradient-to-b from-slate-50 to-white py-20 px-4 rounded-b-[45px] overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsx("div", {
                className: "relative max-w-7xl mx-auto w-full", children: /* @__PURE__ */ jsxs("div", {
                    className: "grid lg:grid-cols-2 gap-16 items-center", children: [
        /* @__PURE__ */ jsxs("div", {
                        className: "space-y-8", children: [
          /* @__PURE__ */ jsxs("h1", {
                            className: "text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight", children: [
        ...
        /* @__PURE__ */ jsxs("div", {
          ...
          /* @__PURE__ */ jsxs("div", {
                            className: "relative bg-white rounded-2xl border border-slate-200 shadow-2xl shadow-blue-100/50 p-8 md:p-10", children: [
            /* @__PURE__ */ jsxs("div", {
            ...
            /* @__PURE__ */ jsx("div", {
                                className: "mt-8 pt-6 border-t border-slate-100", children: /* @__PURE__ */ jsxs("div", {
                                    className: "flex items-center justify-center gap-6 text-sm text-slate-500", children: [
              /* @__PURE__ */ jsxs("div", {
                                        className: "flex items-center gap-2", children: [
...
function PageHeader() {
    ...
    return /* @__PURE__ */ jsx("header", {
        className: "border border-b-dark/15", children: /* @__PURE__ */ jsx("div", {
            className: "mx-auto max-w-7xl px-6 sm:px-8 lg:px-10", children: /* @__PURE__ */ jsxs("div", {
                className: "flex h-[75px] items-center justify-between", children: [
    /* @__PURE__ */ jsxs(
                    Link,
                    {
                        href: "/",
...
function Stepper({
    ...
    /* @__PURE__ */ jsxs("div", {
            className: "min-h-screen bg-light-grey", children: [
      /* @__PURE__ */ jsx(PageHeader, {}),
      /* @__PURE__ */ jsxs("div", {
                className: "max-w-7xl mx-auto space-y-10 py-16 px-4 sm:px-6 lg:px-0", children: [
        /* @__PURE__ */ jsxs("div", {
                    className: "relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6", children: [
          /* @__PURE__ */ jsxs("div", {
                        children: [
          ...
          /* @__PURE__ */ jsxs("div", {
                        className: "group relative flex items-center gap-4 px-5 py-3 rounded-2xl bg-white border border-primary/50 shadow-sm overflow-hidden", children: [
            /* @__PURE__ */ jsx("span", { className: "absolute left-0 top-0 h-full w-[3px] bg-gradient-to-b from-primary to-dark/90" }),
            /* @__PURE__ */ jsx("div", {
                            className: "flex items-center justify-center w-9 h-9 rounded-lg bg-primary/80 text-foreground shrink-0", children: /* @__PURE__ */ jsxs(
                                "svg",
                                {
                                    width: "18",
                                    height: "18",
        ...
        /* @__PURE__ */ jsxs("div", {
                    className: "grid grid-cols-1 md:grid-cols-12 gap-6 items-stretch", children: [
          /* @__PURE__ */ jsxs("aside", {
                        className: "md:col-span-4 glass-dark p-8 rounded-3xl overflow-hidden h-full flex flex-col relative", children: [
            /* @__PURE__ */ jsx("div", { className: "sheen absolute inset-0 pointer-events-none rounded-3xl" }),
            /* @__PURE__ */ jsxs("div", {
                            className: "flex items-center justify-between mb-6", children: [
            ...
            /* @__PURE__ */ jsxs("ul", {
                            className: "space-y-5 text-sm leading-relaxed text-foreground/90", children: [
            ...
            /* @__PURE__ */ jsxs("div", {
                            className: "mt-8 rounded-2xl bg-foreground p-4", children: [
              /* @__PURE__ */ jsx("p", { className: "text-xs uppercase tracking-wide text-muted-foreground", children: "Your price" }),
              /* @__PURE__ */ jsxs("p", {
                                className: "mt-1 text-3xl font-extrabold text-dark", children: [
                                    currency,
                                    pricing.total
                                ]
                            }),
              /* @__PURE__ */ jsxs("p", {
                                className: "mt-2 text-xs text-muted-foreground", children: [
                                    ...
                                    currency,
                                    pricing.base,
                                    pricing.extras > 0 && /* @__PURE__ */ jsxs(Fragment, {
                                        children: [
                                            " ",
                                            "• Extras +",
                                            currency,
            ...
            /* @__PURE__ */ jsxs("div", {
                            className: "mt-auto pt-8", children: [
              /* @__PURE__ */ jsx("div", { className: "text-xs text-foreground/70 mb-2", children: "Progress" }),
              /* @__PURE__ */ jsx("div", {
                                className: "progress-track w-full rounded-full", children: /* @__PURE__ */ jsx(
                                    "div",
                                    {
              ...
              /* @__PURE__ */ jsxs("div", {
                                className: "mt-2 text-xs text-foreground/60", children: [
                                    answeredCount,
                                    "/",
                                    steps.length,
                                    " answered •",
          ...
          /* @__PURE__ */ jsx("section", {
                        className: "md:col-span-8 h-full flex", children: /* @__PURE__ */ jsxs("div", {
                            className: "glass-root p-8 rounded-3xl w-full flex flex-col relative", children: [
            /* @__PURE__ */ jsx("div", { className: "radial-highlight absolute inset-0 pointer-events-none" }),
            /* @__PURE__ */ jsxs("div", {
                                className: "mb-4 flex items-center justify-between", children: [
            ...
            /* @__PURE__ */ jsx("div", {
                                className: "grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl mx-auto w-full", children: displayOptions.map((opt, i) => {
                        ...
                        /* @__PURE__ */ jsxs("div", {
                                                            className: "flex-1 flex flex-col items-start", children: [
                          ...
                          /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: active ? "Best choice for quick fix" : "Tap to select" })
                                                            ...
                                                            opt.price > 0 && /* @__PURE__ */ jsxs("span", {
                                                                className: "text-xs text-muted-foreground", children: [
                                                                    "+",
                                                                    currency,
                                                                    opt.price
            ...
            /* @__PURE__ */ jsxs("div", {
                                className: "mt-auto pt-10 flex items-center justify-between", children: [
              ...
              /* @__PURE__ */ jsxs("div", {
                ...
                /* @__PURE__ */ jsxs(
                      ...
                      /* @__PURE__ */ jsx(FiChevronRight, {})
                                            ...
                                            className: "btn-gloss flex gap-1 items-center cursor-pointer", children: [
                                                "Get Estimate ",
...
function GoogleReview() {
    return /* @__PURE__ */ jsx("div", {
        className: "mt-10 flex justify-center", children: /* @__PURE__ */ jsxs("div", {
            className: "inline-flex items-center gap-3 rounded-full border border-slate-200 bg-white/90 px-4 py-2 shadow-sm", children: [
    ...
    /* @__PURE__ */ jsxs("div", {
                className: "flex flex-col items-start", children: [
      ...
      /* @__PURE__ */ jsxs("div", {
        ...
        /* @__PURE__ */ jsxs("span", {
                        className: "flex items-center gap-0.5 text-amber-400", children: [
...
function QuotePage() {
    ...
    /* @__PURE__ */ jsxs("div", {
            className: "min-h-dvh bg-gradient-to-b from-slate-50 to-white text-slate-900", children: [
      /* @__PURE__ */ jsx(PageHeader, { title: pageTitle }),
      /* @__PURE__ */ jsxs("main", {
                className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-0 mt-16", children: [
        /* @__PURE__ */ jsxs("section", {
                    className: "grid grid-cols-1 md:grid-cols-12 gap-4 items-start", children: [
          /* @__PURE__ */ jsx("div", {
                        className: "md:col-span-7", children: /* @__PURE__ */ jsxs("div", {
                            className: "max-w-2xl md:mx-0 mx-auto text-center md:text-left", children: [
            /* @__PURE__ */ jsxs("div", {
                                className: "inline-flex items-center gap-2 bg-primary/10 text-dark px-3 py-1 rounded-full text-xs font-medium mb-4", children: [
              /* @__PURE__ */ jsx(
                                    "svg",
                                    {
                                        xmlns: "http://www.w3.org/2000/svg",
            ...
            /* @__PURE__ */ jsx("h1", {
                                className: "font-extrabold leading-tight tracking-tight text-4xl sm:text-5xl line-clamp-2", children: (() => {
            ...
            /* @__PURE__ */ jsxs("div", {
                                className: "mt-6 flex flex-col sm:flex-row sm:items-center sm:gap-4 gap-3 justify-center md:justify-start", children: [
              /* @__PURE__ */ jsxs(
                                    Link,
                                    {
                                        href: route(
            ...
            /* @__PURE__ */ jsx("div", {
                                className: "mt-8 flex flex-col sm:flex-row sm:items-center sm:gap-6 gap-4", children: /* @__PURE__ */ jsx("div", {
                                    className: "flex-1 grid grid-cols-1 md:grid-cols-3 gap-5", children: [
                                        {
                                        ...
                                        "div",
                                        {
                                            ...
                                            children: [
                  /* @__PURE__ */ jsx("div", {
                                                className: "h-9 w-9 flex-none rounded-md bg-primary grid place-items-center text-foreground", children: /* @__PURE__ */ jsx(
                                                    "svg",
                                                    {
                                                        xmlns: "http://www.w3.org/2000/svg",
                                                        className: "w-5 h-5",
          ...
          /* @__PURE__ */ jsx("div", {
                        className: "md:col-span-5", children: /* @__PURE__ */ jsxs("div", {
                            className: "rounded-2xl bg-white/60 backdrop-blur-sm border border-white/30 p-6 shadow-[0_18px_40px_rgba(6,34,20,0.06)]", children: [
            /* @__PURE__ */ jsxs("div", {
                                className: "flex items-start justify-between", children: [
              /* @__PURE__ */ jsxs("div", {
                                    className: "flex items-center gap-3", children: [
                /* @__PURE__ */ jsx("div", {
                                        className: "rounded-md bg-primary/10 p-2", children: /* @__PURE__ */ jsx(
                                            "svg",
                                            {
                                                xmlns: "http://www.w3.org/2000/svg",
            ...
            /* @__PURE__ */ jsxs("div", {
                                className: "mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4 items-center", children: [
              /* @__PURE__ */ jsx("div", {
                                    className: "rounded-lg bg-white p-3 border border-white/30 flex items-center justify-center", children: /* @__PURE__ */ jsxs(
                                        "svg",
                                        {
                                            viewBox: "0 0 220 140",
              ...
              /* @__PURE__ */ jsx("div", {
                                    className: "flex items-center justify-center sm:justify-end", children: /* @__PURE__ */ jsx("div", {
                                        className: "w-28 h-28 flex items-center justify-center rounded-full bg-white/60 border border-white/30 p-2", children: /* @__PURE__ */ jsxs(
                                            "svg",
                                            {
                                                width: "84",
                                                height: "84",
            ...
            /* @__PURE__ */ jsxs("div", {
                                className: "mt-4 grid grid-cols-2 gap-3", children: [
              /* @__PURE__ */ jsxs("div", {
                                    className: "rounded-md bg-white p-3 border border-gray-100 text-sm", children: [
...
function AuthenticatedLayout({ header, children }) {
    ...
    return /* @__PURE__ */ jsxs("div", {
        className: "min-h-screen bg-gray-100", children: [
    /* @__PURE__ */ jsx("style", { children: `input { padding: 10px; }` }),
    /* @__PURE__ */ jsxs("nav", {
            className: "border-b border-gray-100 bg-white", children: [
      /* @__PURE__ */ jsx("div", {
                className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", {
                    className: "flex h-16 justify-between", children: [
        /* @__PURE__ */ jsxs("div", {
          ...
          /* @__PURE__ */ jsx("div", {
                            className: "hidden space-x-8 sm:-my-px sm:ms-10 sm:flex", children: /* @__PURE__ */ jsx(
                                NavLink,
                                {
        ...
        /* @__PURE__ */ jsx("div", {
                        className: "hidden sm:ms-6 sm:flex sm:items-center", children: /* @__PURE__ */ jsx("div", {
                            className: "relative ms-3", children: /* @__PURE__ */ jsxs(Dropdown, {
                                children: [
          /* @__PURE__ */ jsx(Dropdown.Trigger, {
                                    children: /* @__PURE__ */ jsx("span", {
                                        className: "inline-flex rounded-md", children: /* @__PURE__ */ jsxs(
                                            "button",
                                            {
                                                type: "button",
          ...
          /* @__PURE__ */ jsxs(Dropdown.Content, {
                                    children: [
            /* @__PURE__ */ jsx(
                                        Dropdown.Link,
                                        {
        ...
        /* @__PURE__ */ jsx("div", {
                        className: "-me-2 flex items-center sm:hidden", children: /* @__PURE__ */ jsx(
                            "button",
                            {
      ...
      /* @__PURE__ */ jsxs(
                "div",
                {
                    ...
                    children: [
            /* @__PURE__ */ jsx("div", {
                        className: "space-y-1 pb-3 pt-2", children: /* @__PURE__ */ jsx(
                            ResponsiveNavLink,
                            {
                                href: route("dashboard"),
                                active: route().current("dashboard"),
            ...
            /* @__PURE__ */ jsxs("div", {
                        className: "border-t border-gray-200 pb-1 pt-4", children: [
              /* @__PURE__ */ jsxs("div", {
                            className: "px-4", children: [
              ...
              /* @__PURE__ */ jsxs("div", {
                            className: "mt-3 space-y-1", children: [
...
function HeroSection() {
    return /* @__PURE__ */ jsx(
        "section",
        {
            ...
            children: /* @__PURE__ */ jsxs("div", {
                className: "relative z-10 mx-auto max-w-[1320px] px-4 sm:px-6 lg:px-0", children: [
        /* @__PURE__ */ jsxs("div", {
                    className: "relative mx-auto mb-6 text-center", children: [
          ...
          /* @__PURE__ */ jsxs("div", {
                        className: "relative flex items-center justify-between", children: [
            /* @__PURE__ */ jsx("h2", {
                            className: "text-4xl sm:text-5xl lg:text-5xl font-bold tracking-tight text-slate-900 mb-6", children: /* @__PURE__ */ jsxs("span", {
                                className: "relative", children: [
                                    "That's",
                                    " ",
              /* @__PURE__ */ jsxs("span", {
...
function HomeTypesStrip() {
    ...
    return /* @__PURE__ */ jsx("section", {
        className: "py-20", children: /* @__PURE__ */ jsxs("div", {
            className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-0 lg:flex lg:items-center lg:gap-16", children: [
    /* @__PURE__ */ jsxs("div", {
                className: "w-full lg:w-[40%] flex flex-col justify-between gap-10 mb-12 lg:mb-0", children: [
      /* @__PURE__ */ jsxs("div", {
                    children: [
        /* @__PURE__ */ jsx("p", { className: "mb-4 text-sm font-semibold tracking-wide text-primary", children: "We service all home types" }),
        /* @__PURE__ */ jsxs("h2", {
                        className: "text-3xl font-bold leading-tight text-light-background sm:text-4xl lg:text-5xl", children: [
    ...
    /* @__PURE__ */ jsx("div", {
                className: "w-full lg:w-[60%] relative", children: /* @__PURE__ */ jsx("div", {
                    className: "overflow-hidden", children: /* @__PURE__ */ jsx(
                        "div",
                        {
                            ref: scrollRef,
                            ...
                            children: homeTypes.map((type) => /* @__PURE__ */ jsx(
                                "article",
                                {
                                    ...
                                    children: /* @__PURE__ */ jsx("div", {
                                        className: "flex h-full relative flex-col justify-between rounded-3xl bg-dark/60 p-6 sm:p-8 ", children: /* @__PURE__ */ jsxs("div", {
                                            children: [
              ...
              /* @__PURE__ */ jsxs("div", {
                                                className: "mb-5 flex items-center gap-4", children: [
                ...
                /* @__PURE__ */ jsxs("h3", {
                                                    className: "text-2xl font-bold leading-7 text-light-background sm:text-3xl", children: [
                                                        type.name,
                                                        " homes"
                                                    ]
                                                })
...
function Home() {
    return /* @__PURE__ */ jsx("main", {
        className: "min-h-screen", children: /* @__PURE__ */ jsxs(GuestLayout, {
            children: [
...
function PrivacyPolicyPage() {
    ...
    /* @__PURE__ */ jsx(Head, { title: pageTitle2 }),
    /* @__PURE__ */ jsxs("div", {
            className: "min-h-screen w-full bg-white text-gray-900 rounded-b-3xl", children: [
      /* @__PURE__ */ jsx(Header, { title: pageTitle2 }),
      /* @__PURE__ */ jsxs("main", {
                className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-0 py-16 pt-28 md:pt-32", children: [
        /* @__PURE__ */ jsxs("div", {
                    className: "mb-8 md:mb-16 mt-6 flex flex-col items-center justify-center md:flex-row md:justify-between md:items-center gap-6", children: [
          /* @__PURE__ */ jsxs("div", {
                        children: [
            /* @__PURE__ */ jsxs("h1", {
                            className: "text-3xl sm:text-5xl font-extrabold leading-tight tracking-tighter text-center md:text-left", children: [
                                "Data ",
          ...
          /* @__PURE__ */ jsx("div", {
                        className: "text-center", children: /* @__PURE__ */ jsxs("p", {
        ...
        /* @__PURE__ */ jsxs("div", {
                    className: "grid grid-cols-1 md:grid-cols-4 gap-0 md:gap-4", children: [
          /* @__PURE__ */ jsxs(
                        "nav",
                        {
                            ...
                            children: [
                /* @__PURE__ */ jsx("div", {
                                className: "md:hidden mb-4", children: /* @__PURE__ */ jsxs("div", {
                                    className: "relative", children: [
                  /* @__PURE__ */ jsx("div", {
                                        className: "flex gap-2 overflow-x-auto no-scrollbar px-1 pb-2", children: SECTIONS$1.map((s) => {
                ...
                /* @__PURE__ */ jsx("div", {
                                className: "hidden md:block md:sticky md:top-10 self-start", children: /* @__PURE__ */ jsxs("div", {
                                    className: "rounded-xl bg-gray-50 border border-gray-200 p-5 shadow-md md:max-h-[calc(100vh-4rem)] md:overflow-y-auto", children: [
                  /* @__PURE__ */ jsx("h2", { className: "text-base font-bold text-gray-700 mb-4 border-b pb-2 border-gray-200", children: "Navigation" }),
                  /* @__PURE__ */ jsx("ul", {
                                        className: "space-y-2 text-base", children: SECTIONS$1.map((s) => {
                                            const isActive = s.id === activeSectionId;
          ...
          /* @__PURE__ */ jsxs("article", {
                        className: "md:col-span-3 space-y-8 md:space-y-12 md:border-l md:border-gray-200 md:pl-8", children: [
            /* @__PURE__ */ jsx(
            ...
            /* @__PURE__ */ jsxs(
                            PolicyTimelineSection,
                            {
                                ...
                                children: [
                  /* @__PURE__ */ jsxs("ul", {
                                    className: "list-disc pl-5 space-y-3 text-gray-700", children: [
                    /* @__PURE__ */ jsxs("li", {
                                        children: [
            ...
            /* @__PURE__ */ jsxs(
                  ...
                  /* @__PURE__ */ jsxs("div", {
                                    className: "mt-4 border-l-4 border-secondary bg-secondary/5 p-4 text-base text-primary rounded-r-lg", children: [
            ...
            /* @__PURE__ */ jsxs(
                  ...
                  /* @__PURE__ */ jsxs("div", {
                                    className: "mt-4 border-l-4 border-yellow-500 bg-yellow-50 p-4 text-base text-yellow-800 rounded-r-lg", children: [
            ...
            /* @__PURE__ */ jsxs(
                  ...
                  /* @__PURE__ */ jsxs("ul", {
                                    className: "list-disc pl-5 space-y-2 text-gray-700", children: [
                    /* @__PURE__ */ jsxs("li", {
                                        children: [
            ...
            /* @__PURE__ */ jsx(
                            PolicyTimelineSection,
                            {
                                ...
                                children: /* @__PURE__ */ jsxs("div", {
                                    className: "mt-4 p-5 rounded-lg border border-primary/60 bg-primary/5 space-y-3", children: [
                  /* @__PURE__ */ jsxs("p", {
                                        children: [
...
const PolicyTimelineSection = ({
    ...
    id, className: "relative", children: [
  /* @__PURE__ */ jsx(
        "div",
        {
    ...
    return /* @__PURE__ */ jsxs(
        ...
        /* @__PURE__ */ jsx("div", {
                className: "py-12", children: /* @__PURE__ */ jsxs("div", {
                    className: "mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8", children: [
          /* @__PURE__ */ jsx("div", {
                        className: "bg-white p-4 shadow sm:rounded-lg sm:p-8", children: /* @__PURE__ */ jsx(
...
function TermsConditionsPage() {
    ...
    /* @__PURE__ */ jsxs("div", {
      ...
      /* @__PURE__ */ jsx(Header, { title: pageTitle2 }),
      /* @__PURE__ */ jsxs("main", {
                className: "mx-auto max-w-7xl px-4 sm:px-6 lg:px-0 py-16 pt-28", children: [
        /* @__PURE__ */ jsxs("div", {
                    className: "mb-8 md:mb-16 mt-6 flex flex-col items-center justify-center md:flex-row md:justify-between md:items-center", children: [
          /* @__PURE__ */ jsxs("div", {
                        className: "", children: [
            /* @__PURE__ */ jsxs("h1", {
                            className: "text-3xl sm:text-5xl font-extrabold leading-tight tracking-tighter text-center md:text-left", children: [
          ...
          /* @__PURE__ */ jsx("div", {
                        className: "text-center", children: /* @__PURE__ */ jsxs("p", {
                            className: "mt-3 text-sm text-gray-400", children: [
                                "Last updated: ",
            /* @__PURE__ */ jsx("br", { className: "md:flex" }),
            /* @__PURE__ */ jsx("span", { className: "font-medium", children: lastUpdated })
                            ]
        ...
        /* @__PURE__ */ jsx("div", {
                    className: "md:hidden mb-10", children: /* @__PURE__ */ jsxs("div", {
                        className: "relative", children: [
          /* @__PURE__ */ jsx("div", {
                            className: "flex gap-2 overflow-x-auto no-scrollbar px-1 pb-2", children: SECTIONS.map((s) => {
                                const isActive = s.id === activeSectionId;
                                return /* @__PURE__ */ jsx(
                                    "a",
                                    {
        ...
        /* @__PURE__ */ jsxs("div", {
                    className: "grid grid-cols-1 md:grid-cols-4 gap-12", children: [
          /* @__PURE__ */ jsx(
                        "nav",
                        {
                            "aria-label": "Table of contents",
                            ...
                            children: /* @__PURE__ */ jsxs("div", {
                                className: "rounded-xl bg-gray-50 border border-gray-200 p-6 shadow-md max-h-[calc(100vh-4rem)] overflow-y-auto", children: [
                /* @__PURE__ */ jsx("h2", { className: "text-base font-bold text-gray-700 mb-4 border-b pb-2 border-gray-200", children: "Contents" }),
                /* @__PURE__ */ jsx("ul", {
                                    className: "space-y-2 text-base", children: SECTIONS.map((s) => {
                                        const isActive = s.id === activeSectionId;
                                        return /* @__PURE__ */ jsx("li", {
                                            children: /* @__PURE__ */ jsx(
                                                "a",
          ...
          /* @__PURE__ */ jsxs("article", {
                        className: "md:col-span-3 space-y-12 md:border-l md:border-gray-200 md:pl-8", children: [
            /* @__PURE__ */ jsx(
                            TermsSection,
                            {
                                id: "agreement",
            ...
            /* @__PURE__ */ jsx(
                            TermsSection,
                            {
                                ...
                                children: /* @__PURE__ */ jsxs("ul", {
                                    className: "list-disc pl-5 space-y-2", children: [
                  /* @__PURE__ */ jsxs("li", {
                                        children: [
